...
public class DrawerItem {
    ...
    private boolean isTextPrimaryBold = false;
    ...
    public DrawerItem setBold( boolean status ) {
        isTextPrimaryBold = status;
        notifyDataChanged();
        return this;
    }

    public boolean isTextPrimaryBold() {
        return isTextPrimaryBold;
    }

    public DrawerItem setColorTextPrimary( int color ) {
